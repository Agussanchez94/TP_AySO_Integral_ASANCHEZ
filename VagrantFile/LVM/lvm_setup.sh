...
# =============================================================
# Script de configuración LVM
# Responsable: R2 - Arquitectura
# Descripción: Crea particiones, PV, VG, LV, formatea y monta
...
# ── PASO 3: Crear VG vg_datos (5G + 3G) ─────────────────────
...
# ── PASO 6: Crear LV lv_workareas (2.5G) ────────────────────
...
# ── PASO 9: Crear puntos de montaje ──────────────────────────
mkdir -p /var/lib/docker
mkdir -p /work

# ── PASO 10: Montajes persistentes en /etc/fstab ─────────────
